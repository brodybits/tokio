...
use crate::core_std::cell::RefCell;
// XXX XXX
#[cfg(feature = "rttt")]
extern crate std;
#[cfg(feature = "rttt")]
...
///
/// Unlike [`crate::core_std::thread::LocalKey`], `tokio::task::LocalKey` will
...
#[cfg(feature = "rttt")]
impl From<crate::core_std::cell::BorrowMutError> for ScopeInnerErr {
    fn from(_: crate::core_std::cell::BorrowMutError) -> Self {
        Self::BorrowError
    }
}
